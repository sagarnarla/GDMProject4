...
for(i in 1:k)
{
	...
	remove_node=gdegree[1,]

	g=delete.vertices(g,remove_node[2])
}
m=get.adjacency(g)
...
plot(seq(200,400,25),svar,type="l",xlab="K",ylab="Effective Strength(beta=0.2,delta=0.7)")
